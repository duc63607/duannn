    ...
    <div class="admin   px-40 py-4 my-10 mx-8 rounded-md">
        ...
        <div class="ad-r">
            ...
            <form action="index.php?act=them_san_pham" method="post" enctype="multipart/form-data" class=""
                ...
                <input type="text" required name="product_name" placeholder="LV ...."
                    class="border w-full px-10 rounded-lg py-2 mt-2">

                <p class="text-[#551AA9] text-[20px] my-4" for="">Giá</p><input required type="text"
                    name="product_price" placeholder="999$ ...." class="border w-full px-10 rounded-lg py-2 mt-2">

                <p class="text-[#551AA9] text-[20px] my-4" for="">Giảm Giá</p><input required type="text"
                    name="product_price_sale" placeholder="899$ ...." class="border w-full px-10 rounded-lg py-2 mt-2">


                <br>
                <label class="uppercase font-1xl  text-[#551AA9] text-[20px] my-4">Mô tả</label>
                <br>
                <textarea required cols="30" rows="10" placeholder="Expensive ..." name="description"
                ...
                <p class="text-[#551AA9] text-[20px] my-4" for="">Origin</p><input required type="text" name="origin"
